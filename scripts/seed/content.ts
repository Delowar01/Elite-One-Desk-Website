...
export const HOME_SECTIONS: SeedSection[] = [
  ...
  },
  {
    ...
    values: {
      ...
      links: [
        ...
        { label: t("Iqama & Employee Services", "خدمات الإقامة والموظفين"), href: "/services/iqama-services", icon: "idCard" },
  ...
  },
  {
    ...
    values: {
      ...
      paths: [
        ...
        { label: t("Business Setup & Company Formation", "تأسيس الأعمال والشركات") },
        { label: t("Iqama & Employee Services", "خدمات الإقامة والموظفين") },
        { label: t("License Renewal & Compliance", "تجديد التراخيص والامتثال") },
        { label: t("Government & General Services", "الخدمات الحكومية والعامة") },
      ],
  ...
  },
  {
    ...
    values: {
      ...
      title: t("Five service groups, one point of contact", "خمس مجموعات خدمات، ونقطة تواصل واحدة"),
      intro: t(
        "Each service group has its own specialists. You still speak to one person.",
        "لكل مجموعة خدمات مختصوها. ومع ذلك تتحدث أنت إلى شخص واحد.",
      ),
      limit: 5,
      showCounts: true,
    },
  ...
  },
  {
    ...
    values: {
      ...
      points: [
        ...
        { label: t("Multiple service categories", "فئات خدمات متعددة"), text: t("Five service groups under one roof, so a request rarely has to go elsewhere.", "خمس مجموعات خدمات تحت سقف واحد، فنادرًا ما يحتاج طلبك إلى جهة أخرى.") },
...
export const FAQS: Array<{ q: L; a: L }> = [
  ...
  },
  {
    q: t(
      ...
      "ما الفرق بين خدمات الإقامة والموظفين وخدمات التأشيرات؟",
    ),
    a: t(
